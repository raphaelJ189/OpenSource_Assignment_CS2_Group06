...
<head>
    ...
    <title>SIMS - Tanzania School Information Management System</title>
    ...
    <div class="layout-wrapper">
        ...
        <aside class="sidebar">
            <div class="sidebar-logo">
                ...
                <div class="logo-text">
                    <span style="font-weight: 700;">MwalimuHub</span>
                    <span style="display: block; font-size: 0.7rem; font-weight: 500; color: var(--text-muted);">SIMS Tanzania</span>
                </div>
            </div>
            ...
            <nav>
                <ul class="sidebar-menu">
                    ...
                    <li class="menu-item <?php echo $current_page === 'students.php' ? 'active' : ''; ?>">
                        <a href="students.php">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <div class="sidebar-footer">
                ...
                <a href="logout.php" class="btn btn-secondary" style="width: 100%; font-size: 0.85rem; padding: 8px 12px; gap: 6px;">
                ...
                <div class="page-title">
                    <h1>
                        ...
                        switch($current_page) {
                            ...
                            case 'search.php': echo 'Student Search Index'; break;
                            default: echo 'Student Information System'; break;
                        }
                        ?>
                    </h1>
                    <p>
                        <?php
                        switch($current_page) {
                            case 'index.php': echo 'Overview of school registrations, metrics, and indicators in Tanzania.'; break;
                            case 'register_student.php': echo 'Enter details to register a student in primary or secondary school.'; break;
                            case 'students.php': echo 'View, filter, and manage student registration records.'; break;
                            case 'search.php': echo 'Locate a student details profile by registration number instantly.'; break;
                            default: echo 'Welcome to MwalimuHub SIMS.'; break;
                        }
                        ?>
                    </p>
                </div>
